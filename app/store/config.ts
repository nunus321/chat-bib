...
export const DEFAULT_CONFIG = {
  ...
  // builtin masks can't be edited/saved directly (they're read-only templates),
  // so a hidden system prompt for one is tracked here by mask id instead.
  hiddenSystemPromptMaskIds: [] as string[],
